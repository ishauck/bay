...
export async function getQuestions(orgId: string, formId: string): Promise<RestResponse<QuestionList>> {
...
export async function createQuestion(orgId: string, formId: string, question: QuestionTypes | QuestionTypes[]): Promise<RestResponse<QuestionList>> {
    const response = await fetch(`/api/orgs/${orgId}/forms/${formId}/questions`, {
        method: "POST",
...
export async function updateQuestions(orgId: string, formId: string, questions: QuestionTypes | QuestionTypes[]): Promise<RestResponse<QuestionList>> {
    const response = await fetch(`/api/orgs/${orgId}/forms/${formId}/questions`, {
        method: "PUT",
